...
export const createUser = async (userData) => {
  const { addUserToFile } = await import('../../../utils/auth');
  return addUserToFile(userData);
};
...
export const updateUserRole = async (username, newRole) => {
  const { updateUserRole: updateRole } = await import('../../../utils/auth');
...
export const updateUserInfo = async (username, updates) => {
  const { updateUserInfo: updateInfo } = await import('../../../utils/auth');
  return updateInfo(username, updates);
};
